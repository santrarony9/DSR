          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {(!activeCategory?.images || activeCategory.images.length === 0) && (
                <p className="text-center text-gray-500 w-full col-span-full py-20 font-light text-lg">No images available in this collection yet.</p>
              )}
            </motion.div>
          </AnimatePresence>
        </div>
        ...
        {selectedImage && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-5xl aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10"
