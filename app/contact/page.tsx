  ...
  const contactDetails = [
    {
      icon: MapPin,
      title: "Visit Us",
      lines: ["104A/22V Karunamoyee Ghat Road", "Kolkata, West Bengal 700082"],
    },
    {
      icon: Phone,
      title: "Call Us",
      lines: ["+91 98305 56659", "Mon-Sat: 10AM - 7PM"],
    },
    {
      icon: Mail,
      title: "Email Us",
      lines: ["dsrevent06@gmail.com", "We reply within 24 hours"],
    },
  ];
